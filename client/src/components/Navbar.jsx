        ...
        {user ? (
          <div className="flex items-center gap-2 sm:gap-3">
            <button className="flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700">
              ...
              <p onClick={() => navigate("/buy")} className="text-xs sm:text-sm font-medium text-gray-600">Credits left : {credit}</p>
            </button>
            <p className="text-gray-600 max-sm:hidden pl-2">Hi, {user.name}</p>
            <div className="relative group">
              <img
                src={assets.profile_icon}
                alt=""
                className="w-10 mt-1 drop-shadow"
              />
          ...
          <div className="flex items-center gap-2 sm:gap-5">
            ...
            className="bg-zinc-800 text-white py-2 sm:px-5 text-sm rounded-full">
              Login
            </button>
          </div>
        )}
