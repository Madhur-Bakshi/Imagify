    ...
    >
      ...
      <div className="flex flex-wrap justify-center gap-5 text-left">
        {plans.map((item, index) => (
          <div
            key={index}
            className="bg-white drop-shadow-sm border rounded-lg py-12 px-10 text-gray-600 
                 hover:scale-105 transition-all duration-500 flex flex-col justify-between h-[350px] w-[280px]"
          >
